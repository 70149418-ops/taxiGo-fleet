...
export const ManageBookings = () => {
  ...
  return (
    <div style={{ 
      background: "#111111", // Deep premium container backdrop block
      padding: "32px", 
      borderRadius: "12px", 
              ...
              {allBookings.map((b) => (
                ...
                >
                  ...
                  <td style={{ padding: "16px 12px" }}>
                    <div style={{ fontWeight: "700", color: "#ffffff", marginBottom: "2px" }}>{b.customerEmail}</div>
                    <div style={{ color: "#666666", fontSize: "11px", fontFamily: "monospace" }}>UID: {b.userId}</div>
                  </td>
                  ...
                  <td style={{ padding: "16px 12px" }}>
                    ...
                    <span style={{ fontSize: "11px", color: "#ffdd00", background: "rgba(255,221,0,0.08)", padding: "2px 6px", borderRadius: "4px", fontWeight: "600" }}>
                      Tier: {b.carType}
                    </span>
                  </td>
