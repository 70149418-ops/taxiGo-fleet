...
export const AdminNavbar = ({ handleLogoutAction }) => {
  ...
  return (
    <>
      <nav style={{
        ...
        borderBottom: "3px double #ffdd00", boxShadow: "0 4px 20px rgba(0,0,0,0.2)",
        position: "relative", zIndex: 1000, fontFamily: "'Inter', sans-serif"
      }}>
        {/* Admin Brand Identity Logo */}
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <span style={{ fontSize: "24px" }}>🛡️</span>
          <Link to="/admin" style={{ color: "#ffffff", textDecoration: "none", fontSize: "20px", fontWeight: "800", letterSpacing: "-0.5px" }}>
            taxiGo <span style={{ color: "#ffdd00", fontWeight: "800", fontSize: "11px", letterSpacing: "1px", textTransform: "uppercase", marginLeft: "6px", backgroundColor: "#222222", border: "1px solid #ffdd00", padding: "4px 10px", borderRadius: "6px" }}>CORE ENGINE</span>
          </Link>
        </div>
      ...
      <div style={{
        ...
        <div style={{ borderBottom: "1px solid #222222", paddingBottom: "16px", marginBottom: "12px" }}>
          <p style={{ margin: "0 0 4px 0", color: "#666666", fontSize: "11px", fontWeight: "700", textTransform: "uppercase" }}>Control Terminal</p>
